...
export default function AddProjectPage() {
  ...
  const [isPostActionDialogOpen, setIsPostActionDialogOpen] = useState(false); // State untuk dialog
  ...
  async function onSubmit(data: ProjectFormValues) {
    try {
      ...
      if (result.success) {
        ...
        form.reset();
        setImagePreview(null);
        setIsPostActionDialogOpen(true); // Tampilkan dialog setelah berhasil
      } else {
        toast({
          variant: "destructive",
  ...
  return (
    <>
      ...
      <PostActionDialog
        ...
        dialogTitle="Proyek Ditambahkan"
        dialogDescription="Proyek baru telah berhasil disimpan. Apa yang ingin Anda lakukan selanjutnya?"
      />
    </>
  );
}
